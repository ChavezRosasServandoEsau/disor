...
/**
 *
 * @author Chavez Rosas Servando Esau 
 */
public class Game extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        gridPaneMatrix.setAlignment(Pos.BOTTOM_CENTER);
        gridPaneMatrix.setStyle("#E0F2F1");
        //gridPaneMatrix.setBackground(Background.EMPTY);
        defineMatrix(60, 30);
        ...
        boxTop.setPadding(new Insets(10, 10, 50, 10));
        boxTop.setSpacing(15);
        boxTop.setAlignment(Pos.CENTER);
        boxTop.setStyle("-fx-background-color: #ECEFF1");
        
        buttonStart = new Button("Iniciar Juego");
        ...
        buttonStart.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                if (Integer.valueOf(calculator.getPopulation()) > 0) {
                    ...
                    alert.setContentText("No ha seleccionado celula");
                    alert.showAndWait();
                }
            }
        });
        
        buttonPause = new Button("Parar");
        ...
        buttonRestore = new Button("Reiniciar");
        buttonRestore.setDisable(false);
        ...
        labelGeneration = new Label("Generación "+calculator.getGeneration());
        ...
        boxTop.getChildren().addAll(buttonStart, buttonPause, buttonRestore, labelGeneration, labelPopulation);       
    ...
    private void updateGeneration() {
        labelGeneration.setText("Generacion: "+calculator.getGeneration());
    }
